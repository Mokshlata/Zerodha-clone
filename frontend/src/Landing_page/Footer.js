    ...
    return (
      <footer style={{backgroundColor:'rgb(250,250,250)'}}>
        <div className='container border-top mt-5'>
          ...
          <a>create a ticket here</a>.</p>
          </div>
         <div className='p-3 mt-3 mb-4 text-muted'>
         <a href=''style={{textDecoration:"none"}}>NSE</a> &nbsp; &nbsp;<a href=''style={{textDecoration:"none"}}>BSE</a>&nbsp; &nbsp; <a href=''style={{textDecoration:"none"}}>MCX</a> &nbsp; &nbsp; <a href=''style={{textDecoration:"none"}}>Terms & conditions</a> &nbsp; &nbsp;<a href=''style={{textDecoration:"none"}}>Policies & procedures</a>&nbsp; &nbsp; <a href=''style={{textDecoration:"none"}}>Privacy policy</a> 
         &nbsp; &nbsp;<a href=''style={{textDecoration:"none"}}>Disclosure</a> &nbsp; &nbsp; <a href=''style={{textDecoration:"none"}}>For investor's attention</a>
         &nbsp; &nbsp;<a href=''style={{textDecoration:"none"}}>Investor charter</a></div>
        </div>
        </footer>
      );
}
